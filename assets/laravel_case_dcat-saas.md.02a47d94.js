import{_ as s,o as a,c as n,N as l}from"./chunks/framework.82ade74d.js";const h=JSON.parse('{"title":"DcatSaas","description":"","frontmatter":{},"headers":[],"relativePath":"laravel/case/dcat-saas.md","lastUpdated":1692165232000}'),e={name:"laravel/case/dcat-saas.md"},p=l(`<h1 id="dcatsaas" tabindex="-1">DcatSaas <a class="header-anchor" href="#dcatsaas" aria-label="Permalink to &quot;DcatSaas&quot;">​</a></h1><p><a href="https://packagist.org/packages/mouyong/dcat-saas" target="_blank" rel="noreferrer"><img src="http://poser.pugx.org/mouyong/dcat-saas/license" alt="License"></a></p><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>一款帮助你在 30 分钟内从 0 搭建 Laravel SaaS 化项目的插件。</p><p>在<code>插件管理器</code>与<code>应用市场管理器</code>的插件架构设计下，采用<code>Tenancy 3.x</code>、<code>Dcat-Admin</code>、<code>Laravel</code> 可快速建立属于你的 SaaS 业务框架。</p><p>初期可采用 <code>Dcat-Admin</code> 完成中心应用开账号，租户应用建立业务逻辑的方案。研发到一定阶段后，推荐采用 <a href="https://lolicode.gitee.io/scui-doc/" target="_blank" rel="noreferrer">scui</a> 或其他你喜欢的管理后台框架，将项目前后端进行分离。</p><p>依赖项目：</p><ul><li><a href="http://gitee.com/fresns/plugin-manager" target="_blank" rel="noreferrer">插件管理器 fresns/plugin-manager</a></li><li><a href="https://gitee.com/fresns/market-manager" target="_blank" rel="noreferrer">应用市场管理器 fresns/market-manager</a></li><li><a href="https://tenancyforlaravel.com/" target="_blank" rel="noreferrer">Tenancy 3.x</a></li><li><a href="http://www.dcatadmin.com/" target="_blank" rel="noreferrer">Dcat-Admin</a></li><li><a href="https://laravel.com/" target="_blank" rel="noreferrer">Laravel</a></li></ul><h2 id="关注代码仓库" tabindex="-1">关注代码仓库 <a class="header-anchor" href="#关注代码仓库" aria-label="Permalink to &quot;关注代码仓库&quot;">​</a></h2><p><a href="https://github.com/mouyong/dcat-saas" target="_blank" rel="noreferrer">点击前往代码仓库</a></p><h2 id="前置要求" tabindex="-1">前置要求 <a class="header-anchor" href="#前置要求" aria-label="Permalink to &quot;前置要求&quot;">​</a></h2><ul><li>Laravel 9+</li><li>Tenancy 3+</li><li>DcatAdmin 2.*</li><li>fresns/plugin-manager ^2</li><li>fresns/market-manager ^1</li><li>项目已完成 fresns/plugin-manager、fresns/market-manager 的安装。</li></ul><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><ol><li>修改扩展包稳定性限制 <code>composer.json</code> 需要允许安装稳定性为 <code>dev</code> 的依赖包。相关设置见下方代码。</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    ...</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="2"><li>初始化</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 创建新项目 saas-test</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ol start="3"><li>使用</li></ol><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 常用命令</span></span>
...
<span class="line"><span style="color:#A6ACCD;">...</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="前后端分离的部署示例" tabindex="-1">前后端分离的部署示例 <a class="header-anchor" href="#前后端分离的部署示例" aria-label="Permalink to &quot;前后端分离的部署示例&quot;">​</a></h2><p>宝塔缓存与前端代理的配置示例：</p><p>搭配 <code>flow.aliyun.com</code> 或宝塔 <code>webhook</code> 可完成项目的 <code>devops</code> 自动化部署。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"># scui</span></span>
...
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="协议" tabindex="-1">协议 <a class="header-anchor" href="#协议" aria-label="Permalink to &quot;协议&quot;">​</a></h2><p><a href="https://github.com/mouyong/dcat-saas/blob/master/LICENSE" target="_blank" rel="noreferrer">Apache 2.0</a></p><h2 id="开发者交流群" tabindex="-1">开发者交流群 <a class="header-anchor" href="#开发者交流群" aria-label="Permalink to &quot;开发者交流群&quot;">​</a></h2><p><a href="https://qm.qq.com/cgi-bin/qm/qr?k=JdZJTPzOEsDo3gCR1ENENRXqWPmM-67l&amp;jump_from=webapi&amp;authKey=5EZ6xwqKptmf3U3QMT/IkclubXceZt2JWqkiQbfwXiELv2d4roHTMX32MmBWoi4q" target="_blank" rel="noreferrer">技术交流群</a> ID: 305795002</p>`,27),o=[p];function t(r,c,i,A,C,d){return a(),n("div",null,o)}const m=s(e,[["render",t]]);export{h as __pageData,m as default};
